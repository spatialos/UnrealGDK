...
| `Plugins/SpatialGDK/SpatialGDKEditorToolbar/` | The SpatialOS Unreal GDK toolbar within the Unreal Editor, from which you can take snapshots, generate interop code, start and stop deployments, and access the SpatialOS Inspector.
