...
pushd "$($gdk_home)"
    ...
    Start-Event "download-unreal-engine" "build-unreal-gdk-:linux:"
    pushd "UnrealEngine"
    ...
    popd
    Finish-Event "download-unreal-engine" "build-unreal-gdk-:linux:"
    ...
    Start-Event "installing-unreal-engine-prerequisites" "build-unreal-gdk-:linux:"
    ...
    Finish-Event "installing-unreal-engine-prerequisites" "build-unreal-gdk-:linux:"
popd