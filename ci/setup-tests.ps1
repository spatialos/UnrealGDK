...
Add-Content -Path "$unreal_path\Engine\Config\BaseEditorSettings.ini" -Value "`r`n[/Script/IntroTutorials.EditorTutorialSettings]`r`nbDismissedAllTutorials=True"
