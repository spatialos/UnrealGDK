...
call :MarkStartOfBlock "Retrieve dependencies"	
	spatial package retrieve internal        legacy-trace-dynamic-x86_64-vc141_md-win32        15.1.0  "%CORE_SDK_DIR%\trace_lib\trace-win32.zip"
	spatial package retrieve internal        legacy-trace-dynamic-x86_64-clang1000-linux       15.1.0  "%CORE_SDK_DIR%\trace_lib\trace-linux.zip"
