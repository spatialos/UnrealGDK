...
The SpatialOS Game Development Kit (GDK) for Unreal enables you to host your game and combine multiple dedicated server instances across one seamless game world, while using the Unreal Engine networking API.
