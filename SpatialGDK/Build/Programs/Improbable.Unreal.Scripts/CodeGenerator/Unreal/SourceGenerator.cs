...
namespace Improbable.CodeGen.Unreal
{
    public static class SourceGenerator
    {
        ...
        {
            List<TypeDescription> allNestedTypes = Types.GetRecursivelyNestedTypes(type);
...
{GenerateTypeFunctions(type.Name, type, bundle)}");
        ...
        {
            string argType = type.ComponentId.HasValue ? "Schema_ComponentData" : "Schema_Object";
            string argName = type.ComponentId.HasValue ? "ComponentData" : "SchemaObject";
            string componentFieldsName = "FieldsObject";
            string targetSchemaObject = type.ComponentId.HasValue ? componentFieldsName : argName;
...
return Data;")}
        ...
        {
            string updatesObjectName = "UpdatesObject";
            string eventsObjectName = "EventsObject";
            string componentUpdateObjectName = "ComponentUpdate";
            string deserializingTargetObjectName = "Data";
