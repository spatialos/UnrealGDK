...
void SpatialOSDispatcherSpy::DropQueuedRemoveComponentOpsForEntity(FSpatialEntityId EntityId) {}
...
bool SpatialOSDispatcherSpy::OnExtractIncomingRPC(FSpatialEntityId EntityId, ERPCType RPCType, const SpatialGDK::RPCPayload& Payload)
{
	return false;
}
