...
public:
	...
	virtual void SendAddComponent(FSpatialEntityId EntityId, FWorkerComponentData* ComponentData, const FSpatialGDKSpanId& SpanId) override;
	virtual void SendRemoveComponent(FSpatialEntityId EntityId, Worker_ComponentId ComponentId, const FSpatialGDKSpanId& SpanId) override;
