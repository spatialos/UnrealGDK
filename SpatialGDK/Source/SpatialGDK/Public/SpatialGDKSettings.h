...
public:
	...
	/**
	 * Enable to change client interest to be calculated using an entity ID list matching the replicated Actors list
	 * generated by the rep graph.
	 */
	UPROPERTY(EditAnywhere, Config, Category = "Interest", meta = (EditCondition = "bEnableClientQueriesOnServer"))
	bool bUseEntityIdListClientQueries;
