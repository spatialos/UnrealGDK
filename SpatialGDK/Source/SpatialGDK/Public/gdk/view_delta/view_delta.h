...
#include "gdk/view_delta/authority_change_storage.h"
#include "gdk/view_delta/component_range_data_storage.h"
#include "gdk/view_delta/component_range_request_storage.h"
#include "gdk/view_delta/component_range_response_storage.h"
#include "gdk/view_delta/component_range_update_storage.h"
#include "gdk/view_delta/entity_change_storage.h"
#include "gdk/view_delta/world_command_storage.h"
...
/** 
 * Represents a set of changes to the view. 
 * Removes duplicate and contradictory information.
 */
class ViewDelta {
public:
...
private:
  ...
  EntityChangeStorage& GetEntityChangeStorage();
  ...
  const EntityChangeStorage& GetEntityChangeStorage() const;
  ...
  EntityChangeStorage entityChangeStorage;
