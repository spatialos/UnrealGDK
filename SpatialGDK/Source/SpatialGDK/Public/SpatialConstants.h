...
namespace SpatialConstants
{
	...
	// TEMP
	const Worker_ComponentId CLIENT_RPC_ENDPOINT_COMPONENT_ID_RB			= CLIENT_RPC_ENDPOINT_COMPONENT_ID - 20;
	const Worker_ComponentId SERVER_RPC_ENDPOINT_COMPONENT_ID_RB			= SERVER_RPC_ENDPOINT_COMPONENT_ID - 20;
	const Worker_ComponentId NETMULTICAST_RPCS_COMPONENT_ID_RB				= NETMULTICAST_RPCS_COMPONENT_ID - 20;
