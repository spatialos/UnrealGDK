...
const Schema_FieldId UNREAL_RPC_EVENT_TRACE_UNIQUE_ID = 5;

const Schema_FieldId UNREAL_COMPONENT_EVENT_DATA_FIELD = 18999; // 1 less than FComponentIdGenerator::RESERVED_COMPONENT_ID_START;
