...
namespace SpatialConstants
{
	enum EntityIds
	{
		...
		WORKER_EXTENTS_ENTITY_ID_FIRST = PLACEHOLDER_ENTITY_ID_LAST + 1,
		WORKER_EXTENTS_ENTITY_ID_LAST = WORKER_EXTENTS_ENTITY_ID_FIRST + 16,
	};
	...
	const Worker_ComponentId WORKER_EXTENTS_COMPONENT_ID					= 9984;
