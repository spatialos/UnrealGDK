...
namespace SpatialGDK
{
	...
	public:
		...
		{
			return FSpatialTraceEventBuilder("process_rpc")
				.AddObject(Object)
		...
		{
			return FSpatialTraceEventBuilder("send_rpc")
				.AddObject(Object)
				.AddFunction(Function)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("queue_rpc")
				.Get();
		}

		static FSpatialTraceEvent RetryRPC()
		{
			return FSpatialTraceEventBuilder("retry_rpc")
				.Get();
		}

		static FSpatialTraceEvent PropertyUpdate(const UObject* Object, const Worker_EntityId EntityId, Worker_ComponentId ComponentId, const FString& PropertyName)
		{
		...
		static FSpatialTraceEvent MergeComponentField(const Worker_EntityId EntityId, const Worker_ComponentId ComponentId, const uint32 FieldId)
		{
		...
		{
			return FSpatialTraceEventBuilder("merge_component")
				.AddEntityId(EntityId)
				.AddComponentId(ComponentId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("send_command_request")
				.AddCommand(Command)
		...
		static FSpatialTraceEvent RecieveCommandRequest(const FString& Command, const UObject* Actor, const UObject* TargetObject, const UFunction* Function, const int32 TraceId,
		...
		{
			return FSpatialTraceEventBuilder("send_remove_entity")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("recieve_remove_entity")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("send_create_entity")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("recieve_create_entity")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("recieve_create_entity_success")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		{
			return FSpatialTraceEventBuilder("send_retire_entity")
				.AddObject(Object)
				.AddEntityId(EntityId)
				.Get();
		}
		...
		static FSpatialTraceEvent ComponentUpdate(const UObject* Object, const UObject* TargetObject, const Worker_EntityId EntityId, const Worker_ComponentId ComponentId)
		{
