...
namespace SpatialGDK
{
	...
	protected:
		...
		{
		public:
			Reader(Worker_ComponentId InComponentId, Schema_FieldId InCountFieldId, Schema_FieldId InACKCountFieldId, Schema_FieldId InFirstRingBufferSlotFieldId)
		...
		public:
			...
			void WriteACKCount(RPCWritingContext::EntityWrite& Ctx, uint64 Count) override { Schema_AddUint64(Ctx.GetFieldsToWrite(), ACKCountFieldId, Count); }
			Schema_FieldId ACKCountFieldId;
