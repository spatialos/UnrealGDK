...
public:
	...
	MonotonicRingBufferWithACKReceiver(TimestampAndETWrapper<FRPCPayload>&& Wrapper, ReaderInterface& Reader, WriterInterface& Writer,
									   int32 NumberOfSlots);
...
{
public:
	SchemaMonotonicRingBufferWithACKReceiver(TimestampAndETWrapper<FRPCPayload>&& Wrapper, Worker_ComponentId InComponentId,
											 Schema_FieldId InCountFieldId, Schema_FieldId InFirstRingBufferSlotFieldId,
											 uint32 InNumberOfSlots, Worker_ComponentId InACKComponentId, Schema_FieldId InACKCountFieldId)
