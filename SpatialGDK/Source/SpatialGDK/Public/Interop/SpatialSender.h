...
public:
	...
	void SendRPCInternal(UObject* TargetObject, UFunction* Function, FUnrealObjectRef TargetObjectRef, USpatialActorChannel* Channel, const SpatialGDK::RPCPayload& Payload);
	void SendRingBufferedRPCInternal(UObject* TargetObject, UFunction* Function, USpatialActorChannel* Channel, FUnrealObjectRef TargetObjectRef, const FRPCInfo& RPCInfo, const SpatialGDK::RPCPayload& Payload);
