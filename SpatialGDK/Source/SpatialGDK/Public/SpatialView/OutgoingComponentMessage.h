...
public:
	...
	explicit OutgoingComponentMessage(FSpatialEntityId EntityId, ComponentData ComponentAdded, const FSpatialGDKSpanId& SpanId)
		: EntityId(EntityId)
	...
	explicit OutgoingComponentMessage(FSpatialEntityId EntityId, ComponentUpdate ComponentUpdated, const FSpatialGDKSpanId& SpanId)
		: EntityId(EntityId)
	...
	explicit OutgoingComponentMessage(FSpatialEntityId EntityId, Worker_ComponentId RemovedComponentId, const FSpatialGDKSpanId& SpanId)
		: EntityId(EntityId)
