...
public:
	...
	virtual FVisibilityResult GetVisibilityResultForLevel(const FVector& LevelPosition, const float LevelExtent,
														  const FIntVector& OriginLocation) const override;
