...
public:
	...
	// Package being loaded, and the set of references depending on it.
	typedef TMap<FNetworkGUID, TSet<FUnrealObjectRef>> PendingRefMap;
	PendingRefMap PendingReferences;
