...
public:
	...
	Worker_ComponentData CreateInterestData(AActor* InActor, const FClassInfo& InInfo, const FEntityId InEntityId) const;
	Worker_ComponentUpdate CreateInterestUpdate(AActor* InActor, const FClassInfo& InInfo, const FEntityId InEntityId) const;
	...
	void AddExtraEntityInterestOnServer(Interest& OutInterest, const TArray<FEntityId>& Entities) const;
...
private:
	...
	Interest CreateInterest(AActor* InActor, const FClassInfo& InInfo, const FEntityId InEntityId) const;
	...
	// authority.
	void AddClientSelfInterest(Interest& OutInterest, const FEntityId& EntityId) const;
	// The components servers need to see on entities they have authority over that they don't already see through authority.
	void AddServerSelfInterest(Interest& OutInterest, const FEntityId& EntityId) const;
	// Add interest to the actor's owner.
	void AddOwnerInterestOnServer(Interest& OutInterest, const AActor* InActor, const FEntityId& EntityId) const;
