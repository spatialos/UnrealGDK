...
const TArray<Worker_ComponentId> REQUIRED_COMPONENTS_FOR_NON_AUTH_CLIENT_INTEREST = TArray<Worker_ComponentId>{
	...
	INITIAL_ONLY_PRESENCE_COMPONENT_ID,
	...
	ACTOR_SET_MEMBER_COMPONENT_ID,
	ACTOR_GROUP_MEMBER_COMPONENT_ID,
...
const TArray<Worker_ComponentId> REQUIRED_COMPONENTS_FOR_LIGHTWEIGHT_SERVER_INTEREST = TArray<Worker_ComponentId>{
	LIGHTWEIGHT_ENTITY_COMPONENT_ID,
	UNREAL_METADATA_COMPONENT_ID,
	SPAWN_DATA_COMPONENT_ID,
};
...
const TMap<Worker_ComponentId, FString> ServerAuthorityWellKnownComponents = {
	...
	{ SERVER_ONLY_ALWAYS_RELEVANT_COMPONENT_ID, "unreal.ServerOnlyAlwaysRelevant" },
