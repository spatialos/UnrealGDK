...
FVisibilityResult USpatialServerLevelStreamingStrategy::GetVisibilityResultForLevel(const FVector& LevelPosition, const float LevelExtent, const FIntVector& OriginLocation) const
{
	return {};
}
