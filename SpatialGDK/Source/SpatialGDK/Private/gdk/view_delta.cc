...
void ViewDelta::AddEntity(EntityId entityId) {
  GetEntityChangeStorage().TryAddEntity(entityId);
}
...
const std::vector<EntityId>& ViewDelta::GetEntitiesAdded() const {
...
EntityChangeStorage& ViewDelta::GetEntityChangeStorage() {
...
const EntityChangeStorage& ViewDelta::GetEntityChangeStorage() const {
  return entityChangeStorage;
}
