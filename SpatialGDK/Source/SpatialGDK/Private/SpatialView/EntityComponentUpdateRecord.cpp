...
{
void EntityComponentUpdateRecord::AddComponentDataAsUpdate(FSpatialEntityId EntityId, ComponentData CompleteUpdate)
{
...
void EntityComponentUpdateRecord::AddComponentUpdate(FSpatialEntityId EntityId, ComponentUpdate Update)
{
...
void EntityComponentUpdateRecord::RemoveComponent(FSpatialEntityId EntityId, Worker_ComponentId ComponentId)
{
...
void EntityComponentUpdateRecord::InsertOrMergeUpdate(FSpatialEntityId EntityId, ComponentUpdate Update)
{
	const EntityComponentId Id = { EntityId, Update.GetComponentId() };
	EntityComponentUpdate* FoundUpdate = Updates.FindByPredicate(EntityComponentIdEquality{ Id });
...
void EntityComponentUpdateRecord::InsertOrSetCompleteUpdate(FSpatialEntityId EntityId, ComponentData CompleteUpdate)
{
	const EntityComponentId Id = { EntityId, CompleteUpdate.GetComponentId() };
	EntityComponentCompleteUpdate* FoundCompleteUpdate = CompleteUpdates.FindByPredicate(EntityComponentIdEquality{ Id });
