...
void ServerWorkerEntityCreator::CreateWorkerEntity()
{
	...
	if (Settings->CrossServerRPCImplementation == ECrossServerRPCImplementation::RoutingWorker)
	{
		...
		Components.Add(ComponentFactory::CreateEmptyComponentData(SpatialConstants::CROSSSERVER_RECEIVER_ENDPOINT_COMPONENT_ID));
		Components.Add(ComponentFactory::CreateEmptyComponentData(SpatialConstants::CROSSSERVER_RECEIVER_ACK_ENDPOINT_COMPONENT_ID));
