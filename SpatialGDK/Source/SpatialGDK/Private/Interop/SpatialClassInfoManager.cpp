...
uint32 USpatialClassInfoManager::GetComponentIdForSpecificSubObject(const UClass& ParentClass, const UClass& SubObjectClass) const
{
	const FString& SubClassPath = SubObjectClass.GetPathName();
