...
void UGlobalStateManager::SendShutdownAdditionalServersEvent()
{
	...
	NetDriver->Connection->SendComponentUpdate(GlobalStateManagerEntityId, &ComponentUpdateWrapper);
}
#endif // WITH_EDITOR
...
void UGlobalStateManager::UpdateSingletonEntityId(const FString& ClassName, const Worker_EntityId SingletonEntityId)
{
	...
	NetDriver->Connection->SendComponentUpdate(GlobalStateManagerEntityId, &UpdateWrapper);
}
