...
namespace SpatialGDK
{
	...
	ServerStdRPCs::ServerStdRPCs(SpatialRPCService_2& Service)
	{
		const USpatialGDKSettings* Settings = GetDefault<USpatialGDKSettings>();
		{
			...
			auto Sender = MakeShared<SchemaMonotonicRingBufferWithACKSender>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
...

		{
			...
			{
				SpatialRPCService_2::RPCQueueDescription Desc;
				auto Sender = MakeShared<SchemaMonotonicRingBufferSender>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
...

		{
			...
			ServerReliableReceiver = MakeShared<SchemaMonotonicRingBufferWithACKReceiver>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
				RPCDesc.LastSentRPCFieldId, RPCDesc.SchemaFieldStart,
				RPCDesc.RingBufferSize, RPCRingBufferUtils::GetAckComponentId(RPCType),
				RPCRingBufferUtils::GetAckFieldId(RPCType));
...

		{
			...
			ServerUnreliableReceiver = MakeShared<SchemaMonotonicRingBufferWithACKReceiver>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
				RPCDesc.LastSentRPCFieldId, RPCDesc.SchemaFieldStart,
				RPCDesc.RingBufferSize, RPCRingBufferUtils::GetAckComponentId(RPCType),
				RPCRingBufferUtils::GetAckFieldId(RPCType));
	...
	ClientStdRPCs::ClientStdRPCs(SpatialRPCService_2& Service)
	{
...

		{
			...
			ClientReliableReceiver = MakeShared<SchemaMonotonicRingBufferWithACKReceiver>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
				RPCDesc.LastSentRPCFieldId, RPCDesc.SchemaFieldStart,
				RPCDesc.RingBufferSize, RPCRingBufferUtils::GetAckComponentId(RPCType),
				RPCRingBufferUtils::GetAckFieldId(RPCType));
...

		{
			...
			ClientUnreliableReceiver = MakeShared<SchemaMonotonicRingBufferWithACKReceiver>(RPCRingBufferUtils::GetRingBufferComponentId(RPCType),
				RPCDesc.LastSentRPCFieldId, RPCDesc.SchemaFieldStart,
				RPCDesc.RingBufferSize, RPCRingBufferUtils::GetAckComponentId(RPCType),
				RPCRingBufferUtils::GetAckFieldId(RPCType));
...
namespace SpatialGDK
{
	FRPCErrorInfo ApplyRPCInternal(USpatialNetDriver* NetDriver, UObject* TargetObject, UFunction* Function, const FPendingRPCParams& PendingRPCParams)
	{
	...
	//bool ProcessRPCs(USpatialNetDriver* NetDriver, const FUnrealObjectRef& Object, const SpatialGDK::RPCPayload& Payload)
	//{
	//	//const FUnrealObjectRef& InTargetObjectRef, const SpatialGDK::RPCSender& InSenderInfo, ERPCType InType, SpatialGDK::RPCPayload&& InPayload,
...
{
	Receiver.ExtractReceivedRPCs([NetDriver](Worker_EntityId EntityId) {return SpatialGDK::CanExtractRPC(NetDriver, EntityId); }
