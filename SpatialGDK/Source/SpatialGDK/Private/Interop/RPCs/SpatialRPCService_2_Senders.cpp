...
uint32 MonotonicRingBufferSender::Write(RPCWritingContext& Ctx, Worker_EntityId EntityId, TArrayView<const FRPCPayload> RPCs,
										const RPCCallbacks::RPCWritten& WrittenCallback)
{
...
uint32 MonotonicRingBufferWithACKSender::Write(RPCWritingContext& Ctx, Worker_EntityId EntityId, TArrayView<const FRPCPayload> RPCs,
											   const RPCCallbacks::RPCWritten& WrittenCallback)
{
