...
void ActorSystem::AddTombstoneToEntity(const Worker_EntityId EntityId) const
{
...
void ActorSystem::RetireEntity(const Worker_EntityId EntityId, bool bIsNetStartupActor)
{
