...
void USpatialNetDriver::CreateAndInitializeCoreClasses()
{
	...
	{
		RPCService = MakeUnique<SpatialGDK::SpatialRPCService>(ExtractRPCDelegate::CreateUObject(Receiver, &USpatialReceiver::OnExtractIncomingRPC), StaticComponentView, USpatialLatencyTracer::GetTracer(GetWorld()), ConnectionManager->GetEventTracer(), this);
	}
