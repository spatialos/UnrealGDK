 ...
 * This test was added after the sequence trigger on a customer test and caused the framework to hang as this flow had not been kept up to
 * date. This is to ensure future regressions do not occur.
 *
...
void ATestingFrameworkShutdownTest::PrepareTest()
{
	...
	AddStep(TEXT("TestingFrameworkShutdownTest Forced Test Failure"), FWorkerDefinition::AllWorkers, nullptr, nullptr,
			[this](float DeltaTime) {
				...
				{
					FinishTest(EFunctionalTestResult::Failed, FString::Printf(TEXT("Testing the failure case followed by timeout.")));
				}
