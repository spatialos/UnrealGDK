...
void ASpatialTestPropertyReplicationMultiworker::PrepareTest()
{
	...
	if (HasAuthority())
	{
		...
		AddExpectedLogError(TEXT("Changed actor without authority with name ReplicatedTestActorBasic_0 of type ReplicatedTestActorBasic, property "
	...
	AddStep(
		...
		[this](float DeltaTime) {
			...
			RequireEqual_String(TestActor->ReplicatedStringProperty, TEXT("hello"), TEXT("The ReplicatedStringProperty should be 'hello'."));
	...
	AddStep(
		...
		[this](float DeltaTime) {
			...
			RequireEqual_String(TestActor->StringProperty, TEXT("hello"),
								TEXT("The ReplicatedStringProperty should be 'hello'."));
