 ...
 *  - The client changes the replicated properties which generates expected errors.
...
void ASpatialTestPropertyReplicationMultiworker::PrepareTest()
{
	...
	if (HasAuthority())
	{
		...
		AddExpectedLogError(TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedIntProperty!"), 2);
		AddExpectedLogError(TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedFloatProperty!"), 2);
		AddExpectedLogError(TEXT("ReplicatedTestActorBasic, property changed without authority was bReplicatedBoolProperty!"), 2);
		AddExpectedLogError(TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedStringProperty!"), 2);
	}
	...
	// Changes on the client also cause expected errors
	AddStep(
		...
		[this]() {
			// Replicated properties
			TestActor->ReplicatedIntProperty = 22;
			TestActor->ReplicatedFloatProperty = 0.22;
			TestActor->bReplicatedBoolProperty = false;
			TestActor->ReplicatedStringProperty = TEXT("world");

			// Non-replicated properties
			TestActor->IntProperty = 22;
			TestActor->FloatProperty = 0.22;
			TestActor->bBoolProperty = false;
			TestActor->StringProperty = TEXT("world");
