...
void ASpatialTestPropertyReplicationMultiworker::PrepareTest()
{
	...
	if (HasAuthority())
	{
		...
		AddExpectedLogError(
			TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedIntProperty!"),
			1);
		AddExpectedLogError(
			TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedFloatProperty!"),
			1);
		AddExpectedLogError(
			TEXT("ReplicatedTestActorBasic, property changed without authority was bReplicatedBoolProperty!"),
			1);
		AddExpectedLogError(
			TEXT("ReplicatedTestActorBasic, property changed without authority was ReplicatedStringProperty!"),
			1);
	}
