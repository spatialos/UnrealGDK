	...
	AddStep(
		...
		[this]() {
			...
			for (AActor* Actor : SpawnActors)
			{
				...
				if (SpawnActor != nullptr)
				{
					AssertTrue(SpawnActor->Int_Initial == 2, TEXT("Check Actor.Int_Initial value."));
...
void ASpatialTestInitialOnlyForInterestActorWithUpdatedValue::FinishTest(EFunctionalTestResult TestResult, const FString& Message)
{
