...
#include "TestMovementCharacte2r.h"
...
ATestMovementCharacter2::ATestMovementCharacter2()
{
	bReplicates = true;
...
void ATestMovementCharacter2::UpdateCameraLocationAndRotation_Implementation(FVector NewLocation, FRotator NewRotation)
{
