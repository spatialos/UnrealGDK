...
namespace SpatialGDKServicesConstants
{
	...
	const FString DockerComposeExe = CreateExePath(DockerPath, TEXT("docker-compose"));
	...
	const FString LocalInstancingFolder = FPaths::Combine(SpatialOSDirectory, TEXT("local_deployment_instancing"));
	const FString DockerComposeYaml = FPaths::Combine(LocalInstancingFolder, TEXT("docker-compose.yml"));
