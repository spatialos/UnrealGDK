...
void FSpatialGDKEditorToolbarCommands::RegisterCommands()
{
	...
	UI_COMMAND(OpenLaunchConfigurationEditorAction, "Create Launch Configuration", "Opens an editor to create Spatial Launch configurations", EUserInterfaceActionType::Button, FInputGesture());
