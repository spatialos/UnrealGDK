...
void FSpatialGDKEditorToolbarCommands::RegisterCommands()
{
	...
	UI_COMMAND(OpenLaunchConfigurationEditorAction, "EditLaunchConfig", "Opens an editor to create Spatial Launch configurations", EUserInterfaceActionType::Button, FInputGesture());
