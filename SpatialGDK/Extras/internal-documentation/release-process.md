...
1. Announce the branch and the commit hash it uses in the `#unreal-gdk-release` channel.
1. Make sure to update UnrealExampleProjectVersion.txt and UnrealGDKVersion.txt so that they contain the relevant release tag for the UnrealGDK and UnrealGDKExampleProject.
