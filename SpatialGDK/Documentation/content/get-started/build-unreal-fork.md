...
1\.  Open a terminal and run either of these commands to clone the [Unreal Engine fork](https://github.com/improbableio/UnrealEngine/tree/4.20-SpatialOSUnrealGDK-release) repository.
...
|     |     |
| --- | --- |
| HTTPS | `git clone https://github.com/improbableio/UnrealEngine.git -b 4.20-SpatialOSUnrealGDK-release` |
| SSH |`git clone git@github.com:improbableio/UnrealEngine.git -b 4.20-SpatialOSUnrealGDK-release`
