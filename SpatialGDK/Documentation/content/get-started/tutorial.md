...
7. From the Unreal Editor toolbar, click **Play** to run the game. This starts two SpatialOS server-worker instances and two SpatialOS [client-worker](https://docs.improbable.io/reference/latest/shared/glossary#client-worker) instances locally, in your Unreal Editor.
