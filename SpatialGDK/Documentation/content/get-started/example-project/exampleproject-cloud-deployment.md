...
1. Add the absolute path to the Launch Config File
    * If you used the InstallGDK.bat script this is `~<directoryname>/UnrealEngine/Samples/UnrealGDKExampleProject/spatial/one_worker_test.json`  
    * If you manually cloned the example project `~<directoryname>/UnrealGDKExampleProject/spatial/one_worker_test.json`  
