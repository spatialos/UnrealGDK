...
<td>Generate default launch config</td>
<td>
...
<li>If you deselect it, you must choose your own launch configuration file in the <strong>Launch configuration</strong> field.</li>
</ul>
</td>
</tr>
<tr>
...
<p><span style="font-weight: 400;"><strong>Note</strong>: This field is valid only when <strong>Generate default launch config</strong> is deselected.</span></p>
</td>
</tr>
<tr>
<td>Stop on exit</td>
...
<p><span style="font-weight: 400;"><strong>Note</strong>: This field might also work for cloud deployment that is started from Unreal Editor.&nbsp; (need to verify)</span></p>
</td>
</tr>
<tr>
...
<p><strong>Note</strong>: The fields in this section are valid only when you select <strong>Generate default launch config</strong>. For information about the definition of each parameter, see <a href="https://docs.improbable.io/reference/13.7/shared/project-layout/launch-config">Launch configuration file</a>.</p>
</td>
</tr>
<tr>
...
<tr>
<td>Schema</td>
<td>Output path for the generated schema</td>
