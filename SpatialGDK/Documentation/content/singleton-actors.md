...
And that's it! You have successfully specified a Singleton Actor. Make sure that if you edit your Actor, you then generate [schema]({{urlRoot}}/content/spatialos-concepts/schema-and-snapshots#schema) and create a new [snapshot]({{urlRoot}}/content/how-to-use-snapshots) using the [SpatialOS GDK toolbar]({{urlRoot}}/content/toolbars).