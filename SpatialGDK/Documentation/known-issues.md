...
<<<<<<< HEAD
| NetMulticast RPCs do not work on singleton objects. | 2019-03-13 | [UNR-856](https://improbableio.atlassian.net/browse/UNR-856) | Do not use NetMulticast RPCs in Singletons.|
=======
| Replicated TimelineComponents are not supported. | 2019-03-14 | [UNR-1105](https://improbableio.atlassian.net/browse/UNR-1105) | Use an alternative method of achieving the desired behaviour, e.g. playing the timeline on a multicast event, or replicating what is changed by the timeline. |
>>>>>>> master
