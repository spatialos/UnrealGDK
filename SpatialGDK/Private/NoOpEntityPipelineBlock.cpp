...
void UNoOpEntityPipelineBlock::EnterCriticalSection()
{
  UE_LOG(LogTemp, Log, TEXT("EnterCriticalSection received"));
}

void UNoOpEntityPipelineBlock::LeaveCriticalSection()
{
  UE_LOG(LogTemp, Log, TEXT("LeaveCriticalSection received"));
}
