...
enum EReplicatedPropertyGroup { REP_SingleClient, REP_MultiClient };
...
enum ERPCType { RPC_Client, RPC_Server, RPC_Unknown };
...
struct FUnrealProperty {
  ...
  TSharedPtr<FUnrealType>
      Type; // Only set if strong reference to object/struct property.
  TSharedPtr<FUnrealRepData>
      ReplicationData; // Only set if property is replicated.
  TSharedPtr<FUnrealMigratableData> MigratableData; // Only set if property is
                                                    // migratable (and not
                                                    // replicated).
  TWeakPtr<FUnrealType>
      ContainerType; // Not set if this property is an RPC parameter.
};
