...
// Generates code to copy an Unreal 'PropertyValue' and write it to a SpatialOS component update
// object 'Update'.
...
// Generates code to extract property data from a SpatialOS component update object and write it to
...
// Generates the appropriate macro for Unreal to read a property from an FFrame in scope. This is
