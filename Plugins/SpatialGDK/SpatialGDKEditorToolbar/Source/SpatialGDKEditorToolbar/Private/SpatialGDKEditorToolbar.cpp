...
bool FSpatialGDKEditorToolbarModule::HandleSettingsSaved() { return true; }

void FSpatialGDKEditorToolbarModule::MapActions(
...
void FSpatialGDKEditorToolbarModule::SetupToolbar(
    TSharedPtr<class FUICommandList> PluginCommands) {
...

  {
    ...
    MenuExtender->AddMenuExtension(
        ...
        FMenuExtensionDelegate::CreateRaw(
            this, &FSpatialGDKEditorToolbarModule::AddMenuExtension));
...
void FSpatialGDKEditorToolbarModule::AddToolbarExtension(
...
void FSpatialGDKEditorToolbarModule::CreateSnapshotButtonClicked() {
  ...
  FString CombinedPath =
      FPaths::Combine(*ProjectFilePath, TEXT("../../../snapshots"));
