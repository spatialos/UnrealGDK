...
namespace Improbable.Unreal.CodeGeneration.Jobs
{
    public class UnrealEntityTemplateJob : CodegenJob
    {
            ...
            : base(outputDirectory, fileSystem)
        {
            ...
            this.unrealComponents = new List<UnrealComponentDetails>();
            foreach (var unrealComponent in unrealComponents)
            {
                // Filter out entity template helper functions for generated interop components.
                if (!unrealComponent.UnderlyingPackageDetails.IsAutoGenerated)
                {
            		this.unrealComponents.Add(unrealComponent);
                }
            }
