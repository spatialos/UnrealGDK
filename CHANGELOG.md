...
- You can now disable logging to spatial for local and/or cloud deployments from the GUI (Project Settings -> Logging). The command line argument -NoLogToSpatial can still be used for that as well.
