...
- Config setting bPreventAutoConnectWithLocator has been renamed to bPreventAutoConnectWithCommandLineArgs. It has been moved into SpatialNetDriver. If using this feature please update the config file appropriatly.
