...
### Features:
- You can now disable logging to spatial from the GUI (Project Settings -> Logging). The command line argument -NoLogToSpatial can still be used for that as well.
