...
- Added a setting to control which CrossServer RPC implementation is used. Both feature mentioned above require the RoutingWorker to properly function. Spatial commands are still the default for now.
