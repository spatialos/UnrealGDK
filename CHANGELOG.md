...
- We've removed a number of scripts from the Example Project and Starter Template, having replaced them with in-Editor workflows in order to maintain a native development experience.
  - The scripts that we removed are: `LaunchSpatial.bat`, `LaunchSimPlayerClient.bat`, `LaunchServer.bat`, `LaunchClient.bat`, `Launch10SimPlayerClients.bat`.
