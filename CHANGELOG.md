...
- Config setting bPreventAutoConnectWithLocator has been renamed to bPreventAutoConnectWithCommandLineArgs. It has been moved to GDK Setting. If using this feature please update enable the setting in GDK Settings.
