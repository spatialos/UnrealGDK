...
{
  // Since we're not receiving actual Unreal packets, Unreal may time out the connection. Timeouts
  // are handled by SpatialOS, so we're setting these values here to keep Unreal happy.
