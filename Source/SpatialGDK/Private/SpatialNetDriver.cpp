                                 ...
                                 bool bReuseAddressAndPort, FString& Error)
{
  ...
  SpatialOSInstance->OnDisconnectedDelegate.AddDynamic(this,
                                                       &USpatialNetDriver::OnSpatialOSDisconnected);
  ...
  if (MaxSortedActors > 0)
  {
    ...
    for (FNetworkObjectInfo* ActorInfo : ConsiderList)
    {
      ...
      if (Actor->NetTag != NetTag)
      {
        ...
        OutPriorityList[FinalSortedCount] = FActorPriority(PriorityConnection, Channel, ActorInfo,
...
void USpatialPendingNetGame::InitNetDriver()
{
  ...
  if (!GDisallowNetworkTravel)
  {
    ...
    if (!NetDriver->InitConnect(this, URL, ConnectionError))
    {
      ...
      {
        ConnectionError =
            NSLOCTEXT("Engine", "NetworkInit", "Error initializing network layer.").ToString();
      }
    }
  }
  else
  {
    ConnectionError = NSLOCTEXT("Engine", "UsedCheatCommands",
