...
public:
  ...
  *
  * @param BlueprintPaths list containing all Blueprint paths that will be
  * scanned for Blueprint
  * assets.
  */
  ...
  */
  ...
  /**
  * Adds a mapping from an AActor to a USpatialOsComponent to the registry. This
  *cache is
  * then used to update components within SpatialOSComponentUpdater.
  *
  * @param Actor the owning AActor for the USpatialOsComponent that is added to
  *the registry.
  ...
  * @param Component the USpatialOsComponent which will be removed from the
  *registry.
  **/
