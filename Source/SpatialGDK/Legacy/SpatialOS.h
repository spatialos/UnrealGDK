...
class SPATIALGDK_API USpatialOS : public UObject
{
  ...
  UFUNCTION(BlueprintCallable, Category = "SpatialOS")
	...
	* If multiple worker instances are started, worker configurations are applied to the first
	* worker
	...
	*/
	 ...
	 *
	 * Remarks:
	 * If a connection attempt has failed, call this method to receive log messages and
	 * disconnection
	 * events.
	 */
	UFUNCTION(BlueprintCallable, Category = "SpatialOS")
