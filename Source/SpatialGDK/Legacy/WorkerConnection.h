...
namespace unreal {
namespace core {
DECLARE_DELEGATE_RetVal_OneParam(bool, FQueueStatusDelegate,
                                 const worker::QueueStatus &)
...
*/
  void
  GetDeploymentListAsync(const FString &ProjectName, const FString &LocatorHost,
  ...
  void ConnectToReceptionistAsync(const FString &Hostname, uint16 Port,
