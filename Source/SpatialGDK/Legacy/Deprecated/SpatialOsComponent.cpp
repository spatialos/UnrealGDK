...
: MaxUpdatesPerSecond(30), Connection(nullptr), View(nullptr), EntityId(0), Callbacks(nullptr), TimeUntilNextUpdate(0), Authority(EAuthority::NotAuthoritative), bIsComponentReady(false), bHasEventQueued(false), Commander(nullptr)
{
}
