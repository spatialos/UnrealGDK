...
UCLASS()
class SPATIALGDK_API USpatialOSBlueprintLibrary
...
public:
  ...
  UFUNCTION(BlueprintPure, meta = (DisplayName = "Not Equal (EntityId)",
                                   CompactNodeTitle = "!="),
            Category = "SpatialOS EntityId")
  ...
  UFUNCTION(BlueprintPure, meta = (DisplayName = "To String"),
            Category = "SpatialOS EntityId")
  static FString EntityIdToString(const FEntityId &EntityId);

  UFUNCTION(BlueprintPure, Category = "SpatialOS Queries",
  ...
  UFUNCTION(BlueprintPure, Category = "SpatialOS Queries",
            meta = (Keywords = "construct build", NativeMakeFunc))
  static FEntityIdQueryConstraint
  MakeEntityIdQueryConstraintFromInt(int InEntityId);

  UFUNCTION(BlueprintPure, Category = "SpatialOS Queries",
            meta = (Keywords = "construct build", NativeMakeFunc))
  static FComponentIdQueryConstraint
  MakeComponentIdQueryConstraintFromComponentId(
      const FComponentId &InComponentId);

  UFUNCTION(BlueprintPure, Category = "SpatialOS Queries",
            meta = (Keywords = "construct build", NativeMakeFunc))
  static FComponentIdQueryConstraint
  MakeComponentIdQueryConstraintFromInt(int InComponentId);

  UFUNCTION(BlueprintPure, Category = "SpatialOS Queries",
            meta = (Keywords = "construct build", NativeMakeFunc))
  static FSphereQueryConstraint
  MakeSphereQueryConstraint(const FVector &InPosition, float InRadius);
  ...
  static UEntityQueryConstraint *SpatialOsEntityAndQuery(
  ...
  static UEntityQueryConstraint *SpatialOsEntityOrQuery(
      const TArray<FEntityIdQueryConstraint> &EntityIds,
      const TArray<FComponentIdQueryConstraint> &ComponentIds,
      const TArray<FSphereQueryConstraint> &Spheres);

  UFUNCTION(BlueprintPure, meta = (DisplayName = "Is Command Successful"),
            Category = "SpatialOS Commands")
  static bool
  IsSuccessful_Command(const FSpatialOSCommandResult &CommandResult);

  UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Command Status Code"),
            Category = "SpatialOS Commands")
  static ECommandResponseCode
  GetCommandStatusCode(const FSpatialOSCommandResult &CommandResult);

  UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Command Error Message"),
            Category = "SpatialOS Commands")
  static FString
  ...
  UFUNCTION(BlueprintPure, meta = (DisplayName = "Not Equal (RequestId)",
                                   CompactNodeTitle = "!="),
            Category = "SpatialOS RequestId")
  static bool NotEqual_FRequestId(const FRequestId &A, const FRequestId &B);

  UFUNCTION(BlueprintPure, meta = (DisplayName = "Is RequestId Valid"),
            Category = "SpatialOS RequestId")
