...
*/
UCLASS()
class SPATIALGDK_API USpatialOSConversionFunctionLibrary
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "SpatialOS Conversions")
	static FVector
	UnrealCoordinatesToSpatialOsCoordinates(const FVector& unrealCoordinates);
	...
	UFUNCTION(BlueprintPure, Category = "SpatialOS Conversions")
	static FVector
	SpatialOsCoordinatesToUnrealCoordinates(const FVector& spatialOsCoordinates);
	...
	UFUNCTION(BlueprintPure, Category = "SpatialOS Conversions")
	static FQuat
	SpatialOsRotationToUnrealRotation(const FQuat& spatialOsRotation);
};
