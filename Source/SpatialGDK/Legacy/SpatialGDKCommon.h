...
using Components = worker::Components<
    ...
    improbable::unreal::PlayerControlClient, improbable::unreal::PlayerSpawner,
    improbable::unreal::UnrealMetadata, improbable::unreal::UnrealCharacterSingleClientRepData,
    improbable::unreal::UnrealCharacterMultiClientRepData,
    improbable::unreal::UnrealCharacterMigratableData,
    improbable::unreal::UnrealCharacterClientRPCs, improbable::unreal::UnrealCharacterServerRPCs,
    ...
    improbable::unreal::UnrealWheeledVehicleServerRPCs, improbable::EntityAcl, improbable::Metadata,
    improbable::Position, improbable::Persistence>;
