...
public:
  ...
  AddComponent(const typename T::Data &data,
    ...
    return FGenericComponentBuilder(InternalEntity, ComponentAuthority,
                                    ReadRequirementSet);
  }
...
public:
  ...
  FReadAclComponentBuilder SetPersistence(bool IsPersistent) {
    ...
    return FReadAclComponentBuilder(InternalEntity, ComponentAuthority,
                                    ReadRequirementSet);
  }
};
...
public:
  ...
  AddMetadataComponent(const improbable::Metadata::Data &data) {
    ...
    return FPersistenceComponentBuilder(InternalEntity, ComponentAuthority,
                                        ReadRequirementSet);
  }
};
...
public:
  ...
  FMetadataComponentBuilder AddPositionComponent(
    ...
    ComponentAuthority.emplace(improbable::Position::ComponentId,
                               WriteRequirement);
    return FMetadataComponentBuilder(InternalEntity, ComponentAuthority,
                                     ReadRequirementSet);
  }
};
