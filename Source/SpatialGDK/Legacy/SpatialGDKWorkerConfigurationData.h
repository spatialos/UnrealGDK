...
struct SPATIALGDK_API FSpatialGDKNetworkingConfiguration
{
	...
	* This is the flow used to connect a managed worker running in the cloud alongside the
	* deployment,
...
struct SPATIALGDK_API FSpatialGDKDebuggingConfig
{
	...
	/**
	  * "BuiltInMetricsReportPeriodMillis" field for an underlying worker::ConnectionParameters
	  * struct.
