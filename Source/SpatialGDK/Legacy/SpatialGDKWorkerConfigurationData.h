...
struct SPATIALGDK_API FSpatialGDKNetworkingConfiguration {
  ...
  FSpatialGDKNetworkingConfiguration()
      : LocatorHost("locator.improbable.io"), ReceptionistHost("127.0.0.1"),
        LinkProtocol(worker::NetworkConnectionType::kRaknet),
        ReceptionistPort(7777),
        RaknetHeartbeatTimeoutMillis(
            worker::defaults::kRakNetHeartbeatTimeoutMillis),
        ReceiveQueueCapacity(worker::defaults::kReceiveQueueCapacity),
        SendQueueCapacity(worker::defaults::kSendQueueCapacity), SteamToken(""),
...
struct SPATIALGDK_API FSpatialGDKDebuggingConfig {
  ...
  FSpatialGDKDebuggingConfig()
      : InfraServiceUrl("https://api.spatial.improbable.io"),
        LogDebugToSpatialOs(false), LogAssertToSpatialOs(false),
        LogWarningToSpatialOs(true), LogErrorToSpatialOs(true),
        BuiltInMetricsReportPeriodMillis(
            worker::defaults::kBuiltInMetricsReportPeriodMillis),
        ...
        ShowDebugTraces(false), UseInstrumentation(true) {}
  ...
  UPROPERTY(EditAnywhere, config, Category = WorkerConfiguration,
            meta = (DeprecatedFunction,
                    DeprecationMessage = "This field is deprecated and will be "
...
struct SPATIALGDK_API FSpatialGDKApplicationConfig {
  ...
  FSpatialGDKApplicationConfig()
      : AppName(""), AssemblyName(""), DeploymentName(""),
        DeploymentTag("prod"), ProjectName(""), WorkerPlatform("UnrealClient"),
        WorkerId(""), LoginToken("") {}
  ...
  UPROPERTY(EditAnywhere, config, Category = WorkerConfiguration,
            meta = (DeprecatedFunction,
                    DeprecationMessage =
                        "This field is deprecated, use ProjectName instead."))
  FString AppName;
  /**
    * This field is not in use. Setting this field will not affect a worker's
   * behaviour.
