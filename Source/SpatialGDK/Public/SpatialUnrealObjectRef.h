...
public:
  ...
  operator improbable::unreal::UnrealObjectRef() const { return ObjectRef; }
  ...
  GetTypeHash(const FHashableUnrealObjectRef &HashableObjectRef) {
    return std::hash<improbable::unreal::UnrealObjectRef>{}(
