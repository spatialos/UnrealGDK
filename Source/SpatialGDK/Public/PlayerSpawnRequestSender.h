 ...
 * Handles retries, in the event of a recoverable failure, by waiting and trying
 * again.
 */
...
public:
  ...
  void RequestPlayer(USpatialOS *InSpatialOS, FTimerManager *InTimerManager,
                     const FURL &Url);
...
private:
  ...
  void HandlePlayerSpawnResponse(
